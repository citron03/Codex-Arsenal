...
export const MANIFEST = [
  ...
  },
  {
    ...
    files: [
      { src: "skills/debug-workflow/SKILL.md", dest: "skills/debug-workflow/SKILL.md" }
    ]
  },
  {
    id: "skill-test-gen",
    ...
    files: [
      { src: "skills/test-gen/SKILL.md", dest: "skills/test-gen/SKILL.md" }
    ]
  },
  {
  ...
  },
  {
    ...
    files: [
      { src: "skills/verifying-agent-changes/SKILL.md", dest: "skills/verifying-agent-changes/SKILL.md" }
    ]
  },
  {
